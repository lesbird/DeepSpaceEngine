...
**Next up**
- [ ] **Planet rotation + day/night cycle** — moving terminator, sunrise/sunset over terrain, sun arcing across the sky
- [ ] **City lights on inhabited worlds** — clustered emissive glow on the night side of life-bearing worlds
- [ ] **Banded gas giants** — procedural zonal cloud bands + swirling storms (gas/ice giants are plain spheres today)
- [ ] **Eclipses & shadows** — moons/planets shadowing one another, ring-shadow-on-planet, solar eclipses from the surface
...
**Terrain fidelity**
- [ ] Micro-relief + strata on the GPU path (full CPU parity — mesas, banded canyon walls)
- [ ] Rivers & lakes (flow-routed hydrology carving the terrain)
- [ ] Up-close vegetation as instanced billboards (trees/grass)
...
- [ ] Galaxy/system map view, location bookmarks (save/load), photo mode
